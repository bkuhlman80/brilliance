...
The motivations in the diagram are reliable behavioral attractors of the unit at its level of organization. This unified definition holds across all four columns.

Motivations don't have to be subjectively experienced to operate as attractors. The genetic column's motivations operate without anything feeling them. The neuronal column's motivations are felt by the organism. The symbolic column's motivations are doubly located — felt by individual members and operating as collective dynamics. The digital column's motivations may or may not be felt; the framework does not require it.

This dissolves two objections at once: the anthropomorphism objection ("bacteria don't feel coordination") and the AI-phenomenology objection ("does the system really comprehend?"). Neither is fatal because feltness is not a precondition for the motivation to operate.
...
Hurricanes are excluded on principled grounds — they don't transmit pattern to successor hurricanes — not on intuitive ones. Computers, networks, AI/ML systems, civilizations, bands, and bacteria all satisfy the criterion in their respective substrates.

## Operational disciplines

These govern how the framework's commitments get operationalized in writing, interpretation, and artifact production.
...
Project documents and downstream artifacts record the current state of the theory, not how it got there. Do not note that a term replaces, supersedes, or was formerly called something else. The theory is not backwards compatible with prior versions of itself. If a term changed, use the new term everywhere and drop the old one without comment.
