# Burns' Deep-Time Segments — Tuning Fork

*Working document. v0.1.*

*Twelve excerpts, one per chapter (Ch 1–12), pulled verbatim from `theory/chapters/`. Each is the passage inside the clade block where Burns closes his eyes and narrates the clade's origin — the "deep time" recitation that opens or anchors the block before the room pulls him back or hands off to Lisa/Bart/Marge. Source file and line numbers given per excerpt for traceability back to the current chapter draft.*

---

## Ch 1 — Protocell

*Source: `ch_1_v2_3.md`, lines 205–229*
...
*Source: `ch_2_v2_8.md`, lines 658–688*
...
*Source: `ch_3_v2_10.md`, lines 154–170*
...
*Source: `ch_4_v2_8.md`, lines 186–202*
...
*Source: `ch_5_v2_2.md`, lines 180–188*
...
*Source: `ch_6_v2_2.md`, lines 180–188*
...
*Source: `ch_7_v2_2.md`, lines 152–156*
...
*Source: `ch_8_v2_4.md`, lines 172–192*
...
*Source: `ch_9_v2_7.md`, lines 235–241*
...
*Source: `ch_10_v2_4.md`, lines 208–216*
...
*Source: `ch_11_v2_4.md`, lines 234–238*
...
*Source: `ch_12_v2_3.md`, lines 222–229*
...
Pulled as a reference sweep, not a draft. Chapters vary in how much room the deep-time gets before the room interrupts (Ch 1–2 run longest; Ch 6, 8 are tightest) — worth noting if the goal downstream is a rhythm check across the twelve rather than close-reading any one. Ch 12 breaks the "closes his eyes" tell explicitly on the page (it's narrated past tense, no dialogue tag for the eyes) — flag if that's a deliberate late-book variation or a drift worth pulling back in line with Ch 1–11.
